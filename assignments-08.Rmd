...
Consider a regression model $Y = \beta_0 + \beta_1 X_1 + \beta_2 X_2 + \varepsilon$, where $X_1$ is a numerical variable and $X_2$ is a dummy variable. Sketch the response curves (the graphs of $E(Y)$ as a function of $X_1$ for different values of $X_2$), if $\eta_0 - 25$, $\beta_1 = 0.2$, and $\beta_2 = -12$.
